      ...
      <div className="mb-8">
        ...
        <div className="mt-4 p-4 bg-green-50 rounded-lg border border-green-200">
          ...
          <div className="text-xs text-green-800 space-y-2">
            ...
            <p>
              <strong>Success Messages</strong> - Uses simple HTML message display
              (green notification box) to show success messages on save. Messages auto-hide after 3 seconds.
            </p>
