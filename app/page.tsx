    ...
    <div className="p-8 max-w-3xl">
      ...
      <div className="mt-6 border-l-4 border-gray-300 pl-4">
        ...
        <ul className="space-y-2 text-sm">
          <li>1.Static Site Generation SSG (this page). No `export const dynamic = &apos;force-dynamic&apos;`. console.log will show only in initial build output. It is just a html page. no custom js to run on client.</li>
